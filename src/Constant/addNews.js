export const news = [{
    id: 1,
    tittle: "Haciendo el clone de youtube con tailwindcss y reactjs.",
    body:` Consumiendo la api de youtube v3 proporcionada por Rapid APi y
...
{
    id: 2,
    tittle: "The Simpsons Fan Page",
    body:`  This is my first web project as such. (7-3-2023) In the
